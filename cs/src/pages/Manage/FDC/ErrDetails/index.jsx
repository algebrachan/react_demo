...
import { downloadAbnormalData, getAbnormalData, getDeviceSearch, getSearchPara } from "../../../../apis/fdc_api";
    ...
    <div>
      ...
      <div className="content_root">
        <Flex vertical gap={20}>
          ...
          <Form.Item label="设备" name="设备" rules={[{required:true}]}>
            <Select
              showSearch
