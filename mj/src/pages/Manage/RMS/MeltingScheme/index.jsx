...
function MeltingScheme() {
      ...
      render: (text, record) => (
        <Space>
          <Button
            ...
            style={{ padding: 0 }}
            onClick={() =>
              navigate("/mng/rms/melting_scheme/edit", {
                state: {
                  opt: "查看",
                  Id: record.id,
                },
  ...
  return (
    <div>
      <MyBreadcrumb items={[window.sys_name, "RMS", "熔融方案管理"]} />
      <div className="content_root">
        <Flex vertical gap={16}>
          <Form layout="inline" form={form} initialValues={default_form_data}>
            <Flex gap={16} wrap="wrap">
              <Form.Item label="方案编号" name="方案编号">
