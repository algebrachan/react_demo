...
function CorrelationAnalysis() {
  ...
  const requestData = () => {
    const { work, 过程参数, 质量参数 } = form.getFieldsValue();
    if (work.length === 0) {
  ...
  return (
    <div>
      <MyBreadcrumb items={["熔融机过程分析", "相关性分析"]} />
                ...
                <GeneralCard name="分析结果">
                  <Spin spinning={load}>
                    <Row gutter={[16, 16]} style={{ padding: 16 }}>
                      ...
                      <Col span={12}>
                        <GeneralCard name="参数趋势图">
                          <div
                            style={{ width: "100%", padding: 10, height: 340 }}
                          >
                            <TransitionLineChart
                              chart_data={chart_data["参数趋势图"]}
                              yLabel={fq["过程参数"]}
                            />
                          </div>
                        </GeneralCard>
                      ...
                      <Col span={12}>
                        <GeneralCard name="相关性随时间的变化">
                          <div
                            style={{ width: "100%", padding: 10, height: 340 }}
                          >
                            <ScatterLineChart
                              chart_data={chart_data["相关性随时间的变化"]}
                              yLabel={fq["过程参数"]}
                            />
                          </div>
                        </GeneralCard>
                      ...
                      <Col span={8}>
                        <GeneralCard name="横向对比图">
                          <div
                            style={{ width: "100%", padding: 10, height: 320 }}
                          >
                            <LineChart
                              chart_data={chart_data["横向对比图"]}
                              {...fq}
                            />
                          </div>
                        </GeneralCard>
                      ...
                      <Col span={8}>
                        <GeneralCard name="线性回归图">
                          <div
                            style={{ width: "100%", padding: 10, height: 320 }}
                          >
                            <ScatterLineChart2
                              chart_data={chart_data["线性回归图"]}
                              {...fq}
                            />
                          </div>
                        </GeneralCard>
