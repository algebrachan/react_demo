...
import { getDevicesInfo } from "../../../apis/mform_api";
    ...
    <div className="home_dev">
      ...
      <GeneralCard name="设备列表">
        ...
        >
          ...
          />
          <DevItem1
            data={{ company: "研磨机", 设备号: "2#", 设备状态: "待机" }}
          />
          <DevItem1
            data={{ company: "研磨机", 设备号: "3#", 设备状态: "待机" }}
          />
          <DevItem2
            data={{ company: "切割机", 设备号: "1#", 设备状态: "待机" }}
          />
          <DevItem2
            data={{ company: "切割机", 设备号: "2#", 设备状态: "待机" }}
          />
          <DevItem2
...
function Home() {
  return (
    <div>
      <MyBreadcrumb items={[window.sys_name, "美晶车间总览"]} />
