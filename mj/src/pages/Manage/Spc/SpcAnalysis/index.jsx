...
import { getSpcOptions, getSpcResult } from "../../../../apis/spc_api";
const { RangePicker } = DatePicker;

const default_query_form = {
  时间: [
    dayjs().subtract(60, "day").format(timeFormat),
...
function SpcAnalysis() {
  ...
  const [tuhao, setTuhao] = useState(true);
  ...
  return (
    <div>
      <MyBreadcrumb items={[window.sys_name, "SPC分析"]} />
      <div
